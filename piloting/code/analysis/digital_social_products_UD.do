...
* load digital social categories, keep which_digital and which_products, and save as .dta
...
destring *, replace
save "data/raw/prolific/digital_social_categories/digital-social-categories_December 6, 2023_10.10.dta", replace


* load digital social products data 
clear all
label drop _all
...
keep(responseid which_digital which_products)
append using "data/raw/prolific/digital_social_categories/digital-social-categories_December 6, 2023_10.10.dta", keep(responseid which_digital which_products)

* count number of responses to which_digital which mention social media
gen social_response = regexm(lower(which_digital), "facebook|pinterest|instagram|linkedin|twitter|snapchat|youtube|whatsapp|reddit|tiktok|nextdoor")
tab social_response

* total count
scalar count_social = sum(social_response == 1)
* total number of responses to which_digital question
egen nonempty_social = total(!missing(which_digital))
